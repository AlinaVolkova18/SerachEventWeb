...
namespace SerachEventWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TaxiOrderContext>(options => options.UseSqlServer(connection));

            //services.AddIdentity<User, IdentityRole>().AddEntityFrameworkStores<TaxiOrderContext>();
